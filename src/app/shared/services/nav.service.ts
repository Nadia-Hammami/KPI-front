    ...
    MENUITEMS: Menu[] = [
        {
            ...
            role: ['Admisrateur',  'Responsable', 'Employee']
        },
        {
            title: 'Dashboard',
            icon: 'home',
        ...
        {
            title: 'User Management', icon: 'users', type: 'sub',  role: ['Admisrateur'], active: false, children: [
                {path: '/user/index', title: 'All Users', type: 'link' , role: ['Admisrateur']},
                {path: '/user/create', title: 'Create New User', type: 'link' , role: ['Admisrateur']},
            ]
        },
    ];
